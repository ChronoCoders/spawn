...
//! `Res`/`ResMut`, deferred resource commands, determinism, and the build-time
//! error for an unregistered resource. The allocation-counting test lives in
//! `resource_no_alloc.rs` (its own binary).
