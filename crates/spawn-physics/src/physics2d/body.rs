//! Rigid-body descriptors and the values read back from the world (2D).

use spawn_core::{Transform2D, Vec2};

use crate::math::BVec2;
use crate::shared::BodyType;

/// Per-axis degree-of-freedom locks. A `true` axis is removed from the solve.
/// Rotation is a single scalar DOF in 2D, hence a single `bool`.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub struct LockFlags {
    pub translation: BVec2,
    pub rotation: bool,
}

/// Linear and angular velocity of a body. Angular velocity is scalar in 2D.
