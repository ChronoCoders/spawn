...
- **State parity under Null.** Every engine operation under `BackendKind::Null` produces the same observable state — voice lifecycle, handle validity, bus volumes — as under a real device.
